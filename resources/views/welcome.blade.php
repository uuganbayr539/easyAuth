...
<html class="no-js" lang="en">
	...
	<body>
		...
		<section id="home" class="welcome-hero">
				        ...
				        <div class="container">
				            ...
				            <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
				                <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
				                    <li class=" scroll active"><a href="#home">Зар оруулах</a></li>
				                    <li class="scroll"><a href="#service">Үйлчилгээ</a></li>
				                    <li class="scroll"><a href="#featured-cars">Сонирхох</a></li>
			...
			<div class="container">
				<div class="welcome-hero-txt">
					...
					{{-- <button class="welcome-btn" onclick="window.location.href='/log'">Зар оруулах</button> --}}

					{{-- <button class="welcome-btn" href="{{ route('login') }}">Зар оруулах</button>
					 ...
					 {{-- @if (Route::has('login')) --}}
							@auth
								{{-- <form action="{{ route('home') }}">
									@csrf
									<button class="welcome-btn" type="submit">Зар оруулах</button>
								</form> --}}
								{{-- <button class="welcome-btn" action="{{ route('home') }}" type="submit">Зар оруулах</button> --}}
							...
							@else
								...
								{{-- <button class="welcome-btn" action="{{ route('login') }}" type="submit">Зар оруулах</button> --}}
		...
		<section id="clients-say"  class="clients-say">
			<div class="container">
				<div class="section-header">
					<h2>Борлуулалтын зөвлөхтэй холбогдох</h2>
				</div><!--/.section-header-->
				<div class="row">
